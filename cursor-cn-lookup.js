...
function printHelp() {
  console.log(`Usage:
  node cursor-cn-lookup.js --key "terminal.integrated.tabs.enabled"
  node cursor-cn-lookup.js --text "Automatically index any new folders"
  node cursor-cn-lookup.js --cursor-root "D:\\\\Codes\\\\cursor" --key "terminal.integrated.windowsEnableConpty"
